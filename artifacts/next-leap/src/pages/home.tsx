      ...
      <div className="w-full max-w-md space-y-8">
        ...
        {lastBoard && (
          <button
            ...
            className="w-full flex items-center justify-between gap-3 bg-card border border-border rounded-[20px] px-4 py-3 text-left shadow-sm hover:border-foreground/30 transition-colors"
          >
            <span className="min-w-0">
              <span className="block font-mono text-[9px] uppercase tracking-widest text-muted-foreground font-bold">
                Back to your board
              </span>
              <span className="block text-[14px] font-medium text-foreground truncate mt-0.5">
        ...
        <div>
          <div className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground font-bold mb-4">
            Next Leap
          </div>
          <h1 className="text-[30px] font-bold font-sans text-foreground leading-tight">
        ...
        {demos && demos.length > 0 && (
          <div className="pt-8 text-center">
            <div className="text-[10px] font-mono uppercase tracking-widest text-muted-foreground font-bold mb-4">
            ...
            <div className="flex gap-3 justify-center flex-wrap">
              {demos.map(demo => (
                ...
                >
                  <div className="font-bold text-foreground font-sans text-[14px]">{demo.title}</div>
